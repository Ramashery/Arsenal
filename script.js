...
function renderPage() {
    ...
    if (globalData.heroBackgroundImageUrl && heroSection) {
        // Updated to support the new overlay logic from CSS
    ...
    function updateCountdown() {
        ...
        // START OF REDESIGN: New countdown HTML structure for vertical layout
    ...
    document.querySelectorAll('[data-i18n-key]').forEach(el => {
        ...
        if (value !== null) {
            ...
            // START OF REDESIGN: Added decorative dashes for the date
            if (key === 'hero.date') {
                value = `— ${value} —`;
            }
            // END OF REDESIGN
...
async function initializeSite() {
    ...
    // --- START OF REDESIGN: Removed floating leaves animation generator ---
    // The related code block has been deleted.
    // --- END OF REDESIGN ---
