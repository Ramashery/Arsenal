...
const defaultSiteData = {
    global: {
        ...
        sliderItems: [],
        teamMembers: [],
        aboutItems: [],    // <-- ИЗМЕНЕНИЕ: Глобальный массив
        eventsItems: [],   // <-- ИЗМЕНЕНИЕ: Глобальный массив
        helpCards: [],     // <-- ИЗМЕНЕНИЕ: Глобальный массив
        materialsItems: [] // <-- ИЗМЕНЕНИЕ: Глобальный массив
    },
    ru: {
        nav: { about: "", trees: "", events: "", help: "", materials: "", team: "", contacts: "" },
        hero: { title: "", subtitle: "", date: "" },
        about: { title: "", items: {} }, // <-- ИЗМЕНЕНИЕ: Массив стал объектом
        slider: {},
        events: { title: "", items: {} }, // <-- ИЗМЕНЕНИЕ: Массив стал объектом
        help: { title: "", intro: "", cards: {} }, // <-- ИЗМЕНЕНИЕ: Массив стал объектом
        map: { title: "", desc: "", goal: "Цель: {count} деревьев", transparency: "" },
        materials: { title: "", intro: "", items: {} }, // <-- ИЗМЕНЕНИЕ: Массив стал объектом
        team: { title: "", members: {} },
