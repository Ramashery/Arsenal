...
function addAdminEventListeners() {
    ...
    document.querySelector('#admin-content-wrapper').addEventListener('click', (e) => {
        ...
        if (actionBtn) {
            ...
            // ИЗМЕНЕНИЕ: Новая логика добавления/удаления для slider и team
            if (path === 'sliderItems') {
                if (action === 'add') {
            ...
            } else if (path === 'treeCategories') { // Старая логика для деревьев
                if (action === 'add') {
            ...
            } else { // Старая логика для секций с отдельными языковыми версиями
