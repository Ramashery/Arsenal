...
function saveAdminChanges() {
    ...
    setTimeout(() => {
        try {
            ...
            // --- НАЧАЛО ИЗМЕНЕНИЯ: Логика сохранения в файл ---
            ...
            // Также обновляем localStorage, чтобы сохранить состояние админки
        ...
        if (actionBtn) {
            ...
            if (path === 'treeCategories') {
                ...
                if (action === 'add') {
                    ...
                    // --- НАЧАЛО ИЗМЕНЕНИЯ: Исправление бага с модальным окном ---
                    const index = parseInt(actionBtn.dataset.index, 10);
