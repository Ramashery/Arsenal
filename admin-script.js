    ...
    ge: {
        ...
        help: {
            ...
            cards: [
                ...
                { id: 'partner', title: "პარტნიორობით", desc: "ჩვენ ღია ვართ თანამშრომლობისთვის არასამთავრობო ორგანიზაციებთან, ბიზნესთან და მედიასთან. ერთად შეგვიძლიя პროექტს ახალი მასშტაბი და ძალა მივცეთ.", details: "", button: "განვიხილოთ პარტნიორობა" }
            ]
        },
        map: {
...
async function saveAdminChanges() {
    ...
    try {
        ...
        document.querySelectorAll('#admin-content-wrapper input, #admin-content-wrapper textarea').forEach(input => {
            ...
            // Если ID поля начинается с 'global', 'ru', 'en', или 'ge', значит путь абсолютный.
            // В противном случае, путь относительный и его нужно строить от текущего языка.
            ...
            if(keys.includes('points')) {
               ...
               let originalValue;
                try {
                    ...
                    // Используем ту же логику для поиска оригинального значения
                    if (!['global', 'ru', 'en', 'ge'].includes(searchKeys[0])) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Global listener for the entire admin panel
    adminPanel.addEventListener('click', (e) => {
        ...
        // --- Content Area Clicks (Breadcrumbs, Lang tabs, Action buttons) ---
