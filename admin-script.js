...
function renderAdminPanel() {
    ...
    // !!! FIX: The call to addAdminEventListeners() is REMOVED from here !!!
}
...
// !!! FIX: This function is no longer needed and can be deleted !!!
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // !!! FIX: All event listeners are now grouped here and set only ONCE !!!
