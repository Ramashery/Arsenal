...
const defaultSiteData = {
    global: {
        ...
        // --- ИЗМЕНЕНИЕ: Слайдер и Команда теперь в global ---
        slider: [
            { img: "https://images.unsplash.com/photo-1615485500608-2f6c6f2a0135?auto=format&fit=crop&w=1200&q=80" },
            { img: "https://images.unsplash.com/photo-1455659817273-f96807779a8a?auto=format&fit=crop&w=1200&q=80" },
            { img: "https://images.unsplash.com/photo-1597834377643-2e3f6e7e0e32?auto=format&fit=crop&w=1200&q=80" },
            { img: "https://images.unsplash.com/photo-1597848212620-4f5bb2a24c34?auto=format&fit=crop&w=1200&q=80" },
            { img: "https://images.unsplash.com/photo-1627324035919-5b58332a67e1?auto=format&fit=crop&w=1200&q=80" },
            { img: "https://images.unsplash.com/photo-1570481662006-a3a1374699d8?auto=format&fit=crop&w=1200&q=80" },
            { img: "https://images.unsplash.com/photo-1544787219-7f47ccb5a8c9?auto=format&fit=crop&w=1200&q=80" },
            { img: "https://images.unsplash.com/photo-1596461404969-9d24c3fdd0c4?auto=format&fit=crop&w=1200&q=80" },
        ],
        team: {
            members: [
                { img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=300&q=80" },
                { img: "https://images.unsplash.com/photo-1552058544-f2b08422138a?auto=format&fit=crop&w=300&q=80" },
                { img: "https://images.unsplash.com/photo-1567532939604-b6b5b0db1604?auto=format&fit=crop&w=300&q=80" },
    ...
    ru: {
        ...
        // --- ИЗМЕНЕНИЕ: Теперь здесь только тексты для слайдера ---
        slider: [
            { title: "Миндаль", desc: "Первым встречает весну бело-розовым облаком цветов." },
            { title: "Айва и яблоня", desc: "Продолжают цветение в апреле, наполняя сад нежными оттенками." },
            { title: "Павловния", desc: "В начале лета раскрывается фиолетовыми колокольчиками." },
            { title: "Тамарикс", desc: "Добавляет лёгкие розовые перья в июне." },
            { title: "Гранат", desc: "Загорается красными цветами и плодами в середине лета." },
            { title: "Скумпия", desc: "Создаёт «дымчатые облака» и вспыхивает осенью красными листьями." },
            { title: "Фисташка", desc: "Уходит в золотисто-оранжевую гамму в октябре." },
            { title: "Кипарис", desc: "Остаётся вечнозелёным символом устойчивости и центра сада." },
        ],
        events: {
            title: "События",
            items: [
        ...
        // --- ИЗМЕНЕНИЕ: Теперь здесь только тексты для команды ---
        team: {
            title: "Команда",
            members: [
                { name: "Александр Савин", role: "Основатель проекта" },
                { name: "Мария Иванова", role: "Координатор волонтеров" },
                { name: "Нино Циклаури", role: "Ландшафтный дизайнер" },
                { name: "Давид Беридзе", role: "PR-менеджер" },
            ]
        },
        contacts: {
            title: "Контакты",
    ...
    en: {
        ...
        slider: [
            { title: "Almond", desc: "The first to greet spring with a white-pink cloud of flowers." },
            { title: "Quince & Apple", desc: "Continue to bloom in April, filling the garden with delicate shades." },
            { title: "Paulownia", desc: "Opens with purple bells at the beginning of summer." },
            { title: "Tamarisk", desc: "Adds light pink feathers in June." },
            { title: "Pomegranate", desc: "Lights up with red flowers and fruits in mid-summer." },
            { title: "Sumac", desc: "Creates 'smoke clouds' and bursts with red leaves in autumn." },
            { title: "Pistachio", desc: "Transitions to a golden-orange palette in October." },
            { title: "Cypress", desc: "Remains an evergreen symbol of resilience and the garden's center." },
        ],
        events: {
            title: "Events",
            items: [
        ...
        team: {
            title: "Our Team",
            members: [
                { name: "Aleksandr Savin", role: "Project Founder" },
                { name: "Maria Ivanova", role: "Volunteer Coordinator" },
                { name: "Nino Tsiklauri", role: "Landscape Designer" },
                { name: "David Beridze", role: "PR Manager" },
            ]
        },
        contacts: {
            title: "Contacts",
    ...
    ge: {
        ...
        slider: [
            { title: "ნუში", desc: "პირველი ხვდება გაზაფხულს თეთრი-ვარდისფერი ყვავილების ღრუბლით." },
            { title: "კომში და ვაშლი", desc: "აგრძელებენ ყვავილობას აპრილში და ბაღს ნაზი ფერებით ავსებენ." },
            { title: "პავლოვნია", desc: "ზაფხულის დასაწყისში იასამნისფერი ზარებით იშლება." },
            { title: "ივანის-ხე", desc: "ივნისში ღია ვარდისფერ ბუმბულებს ამატებს." },
            { title: "ბროწეული", desc: "ზაფხულის შუაში წითელი ყვავილებით და ნაყოფით ინთება." },
            { title: "სუმაკი", desc: "ქმნის „კვამლის ღრუბლებს“ და შემოდგომაზე წითელი ფოთლებით იფეთქებს." },
            { title: "ფისტა", desc: "ოქტომბერში ოქროსფერ-ნარინჯისფერ გამაში გადადის." },
            { title: "კვიპაროსი", desc: "რჩება მარადმწვანე სიმბოლოდ მდგრადობისა და ბაღის ცენტრისა." },
        ],
        events: {
            title: "ღონისძიებები",
            items: [
        ...
        team: {
            title: "ჩვენი გუნდი",
            members: [
                { name: "ალექსანდრე სავინი", role: "პროექტის დამფუძნებელი" },
                { name: "მარია ივანოვა", role: "მოხალისეთა კოორდინატორი" },
                { name: "ნინო წიკლაური", role: "ლანდშაფტის დიზაინერი" },
                { name: "დავით ბერიძე", role: "პიარ მენეჯერი" },
            ]
        },
        contacts: {
            title: "კონტაქტები",
...
function getAdminSectionHTML(sectionKey) {
    ...
    switch(sectionKey) {
        ...
        case 'about':
            ...
            break;
        // --- ИЗМЕНЕНИЕ: Полностью переработанный блок "Слайдер" ---
        case 'slider':
            const sliderAddBtn = `<button class="admin-btn btn-add" data-action="add" data-path="slider">Добавить слайд</button>`;
            html += createBreadcrumbs(sectionKey, sliderAddBtn);
            // Языковые табы здесь больше не нужны
            globalData.slider.forEach((slide, index) => {
                const titleRU = siteData.ru.slider[index]?.title || '';
                html += `
                <div class="admin-card" data-index="${index}">
                    <div class="admin-card-header">
                        <h4>Слайд ${index + 1}: ${titleRU}</h4>
                        <button class="admin-btn btn-delete" data-action="delete" data-path="slider" data-index="${index}">Удалить</button>
                    </div>
                    <div class="admin-card-body">
                        <h5 style="color: var(--admin-text-muted);">Общие данные</h5>
                        ${createImageInput('URL Картинки (общая для всех языков)', `global.slider.${index}.img`, slide.img)}
                        <hr style="border-color: var(--admin-border); margin: 2rem 0;">
                        
                        <h5 style="color: var(--admin-text-muted);">Тексты для языков</h5>
                        ${createInput('Заголовок (RU)', `ru.slider.${index}.title`, siteData.ru.slider[index]?.title)}
                        ${createTextarea('Описание (RU)', `ru.slider.${index}.desc`, siteData.ru.slider[index]?.desc)}
                        
                        ${createInput('Заголовок (EN)', `en.slider.${index}.title`, siteData.en.slider[index]?.title)}
                        ${createTextarea('Описание (EN)', `en.slider.${index}.desc`, siteData.en.slider[index]?.desc)}

                        ${createInput('Заголовок (GE)', `ge.slider.${index}.title`, siteData.ge.slider[index]?.title)}
                        ${createTextarea('Описание (GE)', `ge.slider.${index}.desc`, siteData.ge.slider[index]?.desc)}
                    </div>
                </div>`;
            });
            break;
        ...
        case 'materials':
            ...
            break;
        // --- ИЗМЕНЕНИЕ: Полностью переработанный блок "Команда" ---
        case 'team':
            const teamAddBtn = `<button class="admin-btn btn-add" data-action="add" data-path="team.members">Добавить сотрудника</button>`;
            ...
            globalData.team.members.forEach((member, index) => {
                 const nameRU = siteData.ru.team.members[index]?.name || '';
                html += `
                <div class="admin-card" data-index="${index}">
                    <div class="admin-card-header">
                        <h4>Сотрудник: ${nameRU}</h4>
                        <button class="admin-btn btn-delete" data-action="delete" data-path="team.members" data-index="${index}">Удалить</button>
                    </div>
                    <div class="admin-card-body">
                        <h5 style="color: var(--admin-text-muted);">Общие данные</h5>
                        ${createImageInput('URL Фото (общее для всех языков)', `global.team.members.${index}.img`, member.img)}
                        <hr style="border-color: var(--admin-border); margin: 2rem 0;">
                        
                        <h5 style="color: var(--admin-text-muted);">Тексты для языков</h5>
                        ${createInput('Имя (RU)', `ru.team.members.${index}.name`, siteData.ru.team.members[index]?.name)}
                        ${createInput('Роль (RU)', `ru.team.members.${index}.role`, siteData.ru.team.members[index]?.role)}

                        ${createInput('Имя (EN)', `en.team.members.${index}.name`, siteData.en.team.members[index]?.name)}
                        ${createInput('Роль (EN)', `en.team.members.${index}.role`, siteData.en.team.members[index]?.role)}

                        ${createInput('Имя (GE)', `ge.team.members.${index}.name`, siteData.ge.team.members[index]?.name)}
                        ${createInput('Роль (GE)', `ge.team.members.${index}.role`, siteData.ge.team.members[index]?.role)}
                    </div>
                </div>`;
            });
            break;
...
async function saveAdminChanges() {
    ...
    try {
        ...
        document.querySelectorAll('#admin-content-wrapper input, #admin-content-wrapper textarea').forEach(input => {
            ...
            // Определяем, где искать данные: в глобальном объекте или в языковом
            let current = tempSiteData;
            // Для всех полей, начинающихся с 'global', 'ru', 'en', 'ge', путь строится от корневого объекта
            if (!['global', 'ru', 'en', 'ge'].includes(keys[0])) {
                // Если путь не абсолютный (старая логика для языковых вкладок)
            ...
            if(keys.includes('points')) {
               ...
               let originalValue;
                try {
                    // Ищем оригинальное значение в исходном объекте siteData, чтобы определить тип
                    let searchObj = siteData;
                    originalValue = keys.reduce((obj, k) => obj && obj[k], searchObj);
                } catch (e) {
    ...
    document.querySelector('#admin-content-wrapper').addEventListener('click', (e) => {
        ...
        if (actionBtn) {
            ...
            const confirmAction = (message, callback) => {
                // Упрощенный вызов confirm без манипуляций с z-index, чтобы избежать зависаний
                if (confirm(message)) {
                    callback();
                }
            };
            
            // --- ИЗМЕНЕНИЕ: Новая унифицированная логика для слайдера и команды ---
            if (path === 'slider' || path === 'team.members') {
                const globalPath = path === 'slider' ? siteData.global.slider : siteData.global.team.members;
                const ruPath = path === 'slider' ? siteData.ru.slider : siteData.ru.team.members;
                const enPath = path === 'slider' ? siteData.en.slider : siteData.en.team.members;
                const gePath = path === 'slider' ? siteData.ge.slider : siteData.ge.team.members;
                
                if (action === 'add') {
                    if (path === 'slider') {
                        globalPath.push({ img: "https://source.unsplash.com/1200x800/?nature" });
                        ruPath.push({ title: "Новый слайд", desc: "Новое описание." });
                        enPath.push({ title: "New Slide", desc: "New description." });
                        gePath.push({ title: "ახალი სლაიდი", desc: "ახალი აღწერა." });
                    } else { // team.members
                        globalPath.push({ img: "https://source.unsplash.com/300x300/?portrait" });
                        ruPath.push({ name: "Новый сотрудник", role: "Должность" });
                        enPath.push({ name: "New Member", role: "Role" });
                        gePath.push({ name: "ახალი თანამშრომელი", role: "პოზიცია" });
                    }
                } else if (action === 'delete') {
                    const index = parseInt(actionBtn.dataset.index, 10);
                    const message = `Вы уверены, что хотите удалить этот элемент? Это действие необратимо и затронет ВСЕ языковые версии сайта.`;
                    confirmAction(message, () => {
                        globalPath.splice(index, 1);
                        ruPath.splice(index, 1);
                        enPath.splice(index, 1);
                        gePath.splice(index, 1);
                    });
                }
            } 
            // --- Старая логика для остальных разделов ---
            else if (path === 'treeCategories') {
                if (action === 'add') {
                ...
                const getTargetArray = (lang, pathString) => pathString.split('.').reduce((obj, key) => obj?.[key], siteData[lang]);
                ...
                if (action === 'add') {
                    ...
                    languages.forEach(lang => getTargetArray(lang, path)?.push(deepCopy(newItemTemplate)));

                } else if (action === 'delete') {
                    const index = parseInt(actionBtn.dataset.index, 10);
                    const message = `Вы уверены, что хотите удалить этот элемент?\n\nЭто действие необратимо и затронет ВСЕ языковые версии сайта (RU, EN, GE).`;
                    confirmAction(message, () => {
                        languages.forEach(lang => getTargetArray(lang, path)?.splice(index, 1));
                    });
                }
            }
