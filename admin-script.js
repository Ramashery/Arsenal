...
function getAdminSectionHTML(sectionKey) {
    ...
    switch(sectionKey) {
        ...
        case 'about':
             html += renderLangTabs();
             html += `<div class="admin-content-main">`;
             ...
             html += `
                <div class="admin-content-actions">
                    <button class="admin-btn btn-add" data-action="add" data-path="about.items">Добавить блок "О проекте"</button>
                </div>`;
            break;
        case 'slider':
            html += renderLangTabs();
            ...
            html += `
                <div class="admin-content-actions">
                    <button class="admin-btn btn-add" data-action="add" data-path="slider">Добавить слайд</button>
                </div>`;
            break;
        case 'events':
            html += renderLangTabs();
            ...
            html += `
                <div class="admin-content-actions">
                    <button class="admin-btn btn-add" data-action="add" data-path="events.items">Добавить событие</button>
                </div>`;
            break;
        case 'help':
            html += renderLangTabs();
            ...
            html += `
                <div class="admin-content-actions">
                    <button class="admin-btn btn-add" data-action="add" data-path="help.cards">Добавить карточку помощи</button>
                </div>`;
            break;
         case 'map':
            html += renderLangTabs();
        ...
        case 'trees':
            html += `<div class="admin-content-main">`;
            html += `<p class="admin-text-muted" style="margin-bottom: 1rem;">Здесь вы управляете категориями деревьев для интерактивной карты.</p>`;
            ...
            html += `
                <div class="admin-content-actions">
                    <button class="admin-btn btn-add" data-action="add" data-path="treeCategories">Добавить категорию деревьев</button>
                </div>`;
            break;
        case 'materials':
            html += renderLangTabs();
            ...
            html += `
                <div class="admin-content-actions">
                    <button class="admin-btn btn-add" data-action="add" data-path="materials.items">Добавить материал</button>
                </div>`;
            break;
        case 'team':
            html += renderLangTabs();
            ...
            html += `
                <div class="admin-content-actions">
                    <button class="admin-btn btn-add" data-action="add" data-path="team.members">Добавить сотрудника</button>
                </div>`;
            break;
        case 'contacts':
            html += renderLangTabs();
